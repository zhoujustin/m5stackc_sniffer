...
// ---------------------------------------------------------
#define DEFAULT_DISP_TYPE DISP_TYPE_ST7735S
...
// #endif
  ...
  0x0E,
  #if (DEFAULT_DISP_TYPE == DISP_TYPE_ST7735S)
  TFT_INVONN , 0      ,		// 13: Don't invert display, no args, no delay
  #else
  TFT_INVOFF , 0      ,		// 13: Don't invert display, no args, no delay
  #endif
  TFT_MADCTL , 1      ,		// 14: Memory access control (directions), 1 arg:
  0xC8,						//     row addr/col addr, bottom to top refresh, RGB order
